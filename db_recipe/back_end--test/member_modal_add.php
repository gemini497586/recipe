  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="addModalLabel">新增會員</h5>
      ...
      <form action="memberAdd.php" method="post">
        <div class="modal-body">
          ...
          <div class="form-group">
            ...
            <input  class="form-control" type="text" name="nickname" id="nickname"  maxlength="100">
          </div>
          <!-- 性別 -->
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <input  class="form-control" type="text" name="phone" id="phone" placeholder="09"  maxlength="100">
          </div>
          <!-- email -->
          <div class="form-group">
            <label for="email">Email <span class="text-danger">*</span></label>
            <input  class="form-control" type="text" name="email" id="email" placeholder="@mail.com" required maxlength="100">
          </div>
        </div>
        <div class="modal-footer">
          <button type="submit" class="btn btn-success" name="btn_save">新增</button>
